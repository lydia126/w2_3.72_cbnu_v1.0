...
MODULE GLOBAL
  ...
  REAL(R8)                                           :: G,PI
  REAL(R8)                                           :: DENSITY
  DATA                                        NDC /26/, NHY /15/, NFL /121/      ! cb 6/6/10, CSW 1/3/17
...
MODULE KINETIC
  ...
  REAL,    POINTER,               DIMENSION(:,:)     :: APR,    CHLA,   ATOT, DCELL, CCELL, GCELL      ! CSW 1/3/17
  ...
  !CSW++ 2 parameters are added at the end of ALG lines
  REAL,              ALLOCATABLE, DIMENSION(:)       :: AGEOS, CACEL
  !CSW--
  CONTAINS
