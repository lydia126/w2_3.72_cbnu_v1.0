...
!        ELSE IF(TCNTR(J) == '      WD')THEN
      ...
      DO J=1,TEMPN
        READ(1010,'(8X,100F8.0)')(TEMPCRIT(JW,J),JW=1,NWB)   ! NOTE MAX OF 100 WATERBODIES   sw 4/20/15
      END DO
      CLOSE(1010)
...
14    JDAY1=0.0
  ...
  read (1010,'(//8x,a8,i8,2f8.0)') tspltc, numtsplt, tspltfreq, tsconv
  ...
  read (1010,'(/)')
  do j=1,numtsplt
    read (1010,'(8x,a8,i8,a8,3f8.0,2a8,i8,a8)') tspltcntr(j), tspltjb(j), tsyearly(j), tstsrt(j), tstend(j),                       &
  ...
  read (1010,'(/)')
  do j=1,numtsplt
    read (1010,'(8x,10i8)') (jstsplt(j,n),n=1,nouts(j))
  end do
  read (1010,'(/)')
  do j=1,numtsplt
    read (1010,'(8x,10f8.0)') (tsdepth(j,n),n=1,nouts(j))
  end do
  read (1010,'(/)')
  do j=1,numtsplt
    read (1010,'(8x,10f8.0)') (tsminfrac(j,n),n=1,nouts(j))
  end do
  read (1010,'(/)')
  do j=1,numtsplt
    read (1010,'(8x,10i8)') (tsprior(j,n),n=1,nouts(j))
  end do
  read (1010,'(/)')
  do j=1,numtsplt
    read (1010,'(8x,10f8.0)') (tsminhead(j,n),n=1,nouts(j))
  end do
  read (1010,'(/)')
  do j=1,numtsplt
    read (1010,'(8x,10f8.0)') (tsmaxhead(j,n),n=1,nouts(j))
  end do
  read (1010,'(/)')
  do j=1,numtsplt
    read (1010,'(8x,10f8.0)') (tsmaxflow(j,n),n=1,nouts(j))
  end do
