      ...
      DO J=1,NIKTSR  
        ...
        IF (ICE_COMPUTATION) THEN  
          IF(SEDIMENT_CALC(JW))THEN  
            ...
            BI(KTWB(JW),I),SHADE(I),ICETH(I),rn(i),rs(i),ranlw(jw),rb(i),re(i),rc(i),(ADJUSTR(C2CH(JAC)),JAC=1,NAC),                      &  ! CB 7/26/07
        ...
        ELSE  
          IF(SEDIMENT_CALC(JW))THEN  
            ...
            BI(KTWB(JW),I),SHADE(I),rn(i),rs(i),ranlw(jw),rb(i),re(i),rc(i),(ADJUSTR(C2CH(JAC)),JAC=1,NAC),(ADJUSTR(EPCH(JE)),            &  ! CB 7/26/07
